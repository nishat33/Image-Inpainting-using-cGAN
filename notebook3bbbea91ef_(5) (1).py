# -*- coding: utf-8 -*-
"""notebook3bbbea91ef (5).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19tvQaOxHTjQsR1s_6wGDdFZG2hrTv9dd
"""
...
for epoch in range(num_epochs):
    ...
    for i, batch in enumerate(train_dataloader):
        ...
        g_loss = criterion_gan(discriminator_d1(refined_images), torch.ones(refined_images.size(0), 1, device=refined_images.device))
