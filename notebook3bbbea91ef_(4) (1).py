...
class UNetUp(nn.Module):
    def __init__(self, in_size, out_size, skip_channels, dilation, dropout=0.0):
        ...
        layers = [
            nn.ConvTranspose2d(in_size, out_size+skip_channels, kernel_size=4, stride=2, padding=1, bias=False, dilation=dilation),
...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.up1 = UNetUp(512, 512, 512, 2, dropout=0.5)
        self.up2 = UNetUp(1024, 512, 512, 2, dropout=0.5)
        self.up3 = UNetUp(1024, 512, 512, 2,dropout=0.5)
        self.up4 = UNetUp(1024, 512, 512, 2,dropout=0.5)
        self.up5 = UNetUp(1024, 256, 256, 2)
        self.up6 = UNetUp(512, 128, 128, 2)
        self.up7 = UNetUp(256, 64, 64, 2)
